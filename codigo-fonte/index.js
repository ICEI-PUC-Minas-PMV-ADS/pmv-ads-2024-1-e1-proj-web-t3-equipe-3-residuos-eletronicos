...
let articles = [
    ...
    { id: 2, title: 'Mercúrio (Hg)', description: 'Mercúrio em Dispositivos Eletrônicos: Impactos e Manejo.', link: 'artigo2.html' },
    { id: 3, title: 'Cádmio (Cd)', description: 'Cádmio em Resíduos Eletrônicos: Um Metal Tóxico e Persistente.', link: 'artigo3.html' },
    { id: 4, title: 'Bifenilos Policlorados (PCBs) em Equipamentos Eletrônicos Antigos', description: 'Bifenilos Policlorados (PCBs) em Equipamentos Eletrônicos Antigos', link: 'artigo4.html' },
    { id: 5, title: 'Retardantes de Chama Bromados (BFRs)', description: 'Retardantes de Chama Bromados em Plásticos de Dispositivos Eletrônicos', link: 'artigo5.html' },
    { id: 6, title: 'Ftalatos', description: 'Ftalatos em Cabos e Componentes Eletrônicos', link: 'artigo6.html' },
    { id: 7, title: 'Arsênio (As)', description: 'Arsênio em Componentes Eletrônicos: Riscos e Reciclagem', link: 'artigo7.html' },
