...
|Caso de Teste    | CT- 08 -  Verificar se o site localiza os pacientes cadastrados e não cadastrados |
|:---|:---|
...
|Caso de Teste    | CT- 09 -  Verificar se os caracteres especiais nos nomes de usuário ou senhas são tratados corretamente. |
|:---|:---|
| Requisitos Associados | RF-01: A aplicação deve permitir dois tipos de usuários para login: profissionais da saúde e pacientes. |
